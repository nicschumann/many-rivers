...
function assert_parent(parent: unknown): asserts parent {
    if (typeof parent == 'undefined') { throw new Error('Parent simulation not set on View; call set_parent.')}
}
...
class View {
    ...
    constructor(x: number, y: number, z: number, testcase=false, shaders : CompiledDrawCalls, regl: Regl) {
