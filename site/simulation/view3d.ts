...
class View3D extends View {
    ...
    render(resources: RenderResources, simdata: SimulationData, uidata: UIData) {
        ...
        if (this.parent.loaded) {
            ...
            const base_height = camera_dist * 80.0
            let current_height = base_height;

            if (uidata.render_depth && uidata.active_overlay == UIOverlayState.SimTools) {
            ...
            if (uidata.render_curvature && uidata.active_overlay == UIOverlayState.SimTools) {
            ...
            if (uidata.render_erosion_accretion && uidata.active_overlay == UIOverlayState.SimTools) {
            ...
            if (uidata.render_flux && uidata.active_overlay == UIOverlayState.SimTools) {
